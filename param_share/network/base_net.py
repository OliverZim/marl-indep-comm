    ...
    def forward(self, obs, hidden_state, msgs=None, agent_num=None):
        ...
        if self.args.with_comm:
            ...
            if agent_num != None:
                ...
                # TO RECEIVE ALL MSGS
                idxs = torch.tensor([i for i in range(self.args.n_agents) if i != agent_num]).to(
                ...
                msgs_repective_idxs_no_0 = msgs_repective_idxs[msgs_repective_idxs.count_nonzero(dim=-1) != 0].reshape(
